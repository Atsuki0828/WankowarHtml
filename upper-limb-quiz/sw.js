const CACHE='upper-limb-quiz-v2';
const ASSETS=['./','./index.html','./styles.css','./questions-1.js','./questions-2.js','./questions-3.js','./questions-4.js','./questions-5.js','./app.js','./manifest.webmanifest'];
